...
# of the multiple models that one might use in order to classify new data.
...
#        . 1j - Ensemble Model - Classify Gender by Test Grade - Synthetic
...
# In the file 1j the methods become far more sophisticated. 10-fold Cross
# Validation is used for each model. For example, the data is split 90/10, and
